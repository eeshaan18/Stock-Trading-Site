...
exports.getStockMetaData = async (req, res) => {
  try {
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}?token=1d255a96ad33d46e0125aa727afd09e244f381ed`;
...
exports.getStockHistoricData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${req.params.ticker}/prices?startDate=${year}-${month}-${day}&token=1d255a96ad33d46e0125aa727afd09e244f381ed`;
...
exports.getRandomStockData = async (req, res) => {
  try {
    ...
    const url = `https://api.tiingo.com/tiingo/daily/${stock.ticker}/prices?startDate=${year}-${month}-${day}&token=1d255a96ad33d46e0125aa727afd09e244f381ed`;
